...
const statusConfigs: Record<string, { variant: BadgeVariant; label: string; color?: string }> = {
  // Estados generales
  active: {
    variant: "default",
    label: "Activo",
...
export function StatusBadge({ status, label, customColor, className }: StatusBadgeProps) {
