          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive ? "bg-accent text-primary font-medium" : "text-gray-500 hover:bg-gray-100 hover:text-primary",
              )}
            >
              <item.icon className={cn("h-5 w-5 mr-2", isActive ? "text-primary" : "text-gray-400")} />
