...
export function FilterPanel({
    visible, filters, scenarios, activityAreas, neighborhoods, onChange, onToggle,
}: Props) {
    const local = { ...filters };
        ...
        <div className="mb-4 animate-in fade-in">
            <Card>
                <CardHeader className="pb-2">
                    ...
                    <CardDescription>Refina los resultados usando los siguientes filtros</CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        {[
                            ...
                            { id: "activityAreaId", label: "Área Actividad", data: activityAreas },
                            ...
                            <div key={opt.id} className="space-y-2">
                                ...
                                <select
                                    ...
                                    onChange={e => set(opt.id as keyof FilterState,
