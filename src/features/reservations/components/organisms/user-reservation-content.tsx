...
import { Calendar, CheckCircle2, Clock, Filter, Search, Settings, User, X } from "lucide-react";
import { useRouter } from "next/navigation";
import { useState } from "react";
import { useUserReservations } from "../../hooks/use-user-reservations.hook";
import { ErrorReservationsLoading } from "./error-loading";
import { ModernReservationItem } from "./modern-reservation-item";
import { ModifyReservationModal } from "./ModifyReservationModal";
import { ReservationsLoader } from "./reservations-loader";
import { UserNotFound } from "./user-not-found";

export function UserReservationsContent({ userId }: { userId: string }) {
